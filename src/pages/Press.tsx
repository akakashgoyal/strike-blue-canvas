...
const pressItems = [
  {
    id: 1,
    title: `“Krispy Rishtey”: A 15-Song Musical Journey Directed by Jagat Singh and Produced by Sagar Shrivastwa, Now on Jio Cinema`,
    publication: "The Print",
    date: "19 October 2024",
    image: Img1,
    link: "https://theprint.in/ani-press-releases/krispy-rishtey-a-15-song-musical-journey-directed-by-jagat-singh-and-produced-by-sagar-shrivastwa-now-on-jio-cinema/2319286/?utm_source=chatgpt.com ",
  },
  {
    id: 2,
    title: "Krispy Rishtey",
    publication: "Filmy Beat",
    date: "November 2024",
    image: Img2,
    link: "https://www.filmibeat.com/bollywood/movies/krispy-rishtey.html?utm_source=chatgpt.com",
  },
  {
    id: 3,
    title:
      "Sagar Shrivastwa's Krispy Rishtey featuring 15 songs by Jagat Singh now streaming for viewers",
    publication: "The Times of India",
    date: "23 October 2024",
    image: Img1,
    link: "https://timesofindia.indiatimes.com/entertainment/sagar-shrivastwas-krispy-rishtey-featuring-15-songs-by-jagat-singh-now-streaming-for-viewers/articleshow/114505576.cms ",
  },
  {
    id: 4,
    title: `
EXCLUSIVE: Jagat Singh Solanki speaks about Sagar Shrivastava being the ‘driving force’ for his debut film Krispy Rishtey; reminisces about the song sung by KK`,
    publication: "Bollywood Hungama",
    date: "July 9 2022",
    image: Img3,
    link: "https://www.bollywoodhungama.com/news/features/exclusive-jagat-singh-solanki-speaks-sagar-shrivastava-driving-force-debut-film-krispy-rishtey-reminisces-song-sung-kk/ ",
  },
  {
    id: 5,
    title:
      "15 गाने और एक कहानी, रिलीज हुई म्यूजिकल ड्रामा 'क्रिस्पी रिश्ते', इस OTT पर देखें",
    publication: "NDTV Movie",
    date: "19 October 2024",
    image: Img1,
    link: "https://ndtv.in/bollywood/15-songs-one-story-krispy-rishtey-jagat-singh-sagar-srivastava-film-now-on-jio-cinema-6827843 ",
  },
  {
    id: 6,
    title: `Exclusive Premiere of 'Krispy Rishtey' | Jagat Singh & Sagar Shrivastava at the Press Meet`,
    publication: "MTI News",
    date: "18 October 2024",
    image: "https://img.youtube.com/vi/ASWqIUvT5Xs/maxresdefault.jpg",
    link: "https://www.youtube.com/watch?v=ASWqIUvT5Xs ",
  },
];
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              ...
              recognition from leading publications worldwide.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                <span className="inline-block px-4 py-2 bg-gradient-to-r  to-[#38b6f0]  from-[#de4445] text-white text-sm font-bold rounded-full">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              <div className="mb-6 p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl">
                <span className="font-display text-4xl text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-500">
                  STRIKE
                </span>
              </div>
